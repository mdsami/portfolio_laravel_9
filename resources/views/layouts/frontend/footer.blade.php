	...
	<div id="config-panel" class="config-panel d-none d-lg-block">
		<div class="panel-inner">
			...
			<ul id="color-options" class="list-inline mb-0">
				<li class="theme-1  list-inline-item"><a data-style="{{ asset('assets/css/theme-1.css') }}" href="#"></a></li>
				<li class="theme-2  list-inline-item"><a data-style="{{ asset('assets/css/theme-2.css"') }} href="#"></a></li>
				<li class="theme-3  active list-inline-item"><a data-style="{{ asset('assets/css/theme-3.css') }}" href="#"></a></li>
				...
				<li class="theme-9  list-inline-item"><a data-style="{{ asset('assets/css/theme-9.css') }}" href="#"></a></li>
				<li class="theme-10  list-inline-item"><a data-style="{{ asset('assets/css/theme-10.css') }}" href="#"></a></li>
			</ul>
